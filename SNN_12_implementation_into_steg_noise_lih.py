...
def simulate_text_encoding(text, sim_time=50.0):
    ...
    plot_raster([senders1, senders2, senders3, noise_senders, lateral_ih_senders],
                [ts1, ts2, ts3, noise_ts, lateral_ih_ts],
                sim_time)
...
def plot_raster(senders_list, times_list, sim_time):
    labels = ['Layer 1', 'Layer 2', 'Layer 3', 'Noise Layer', 'Lateral Inhibition Layer']
    fig, axs = plt.subplots(len(senders_list), 1, figsize=(10, 12), sharex=True)
    ...
    plt.suptitle(
        'Raster Plot of All Layers, including Noise and Lateral Inhibition Layers,\n encoding of the text string:\n "THE QUICK BROWN FOX JUMPS OVER THE LAZY DOG"')
